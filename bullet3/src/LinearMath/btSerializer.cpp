...
 .†  òñ 	0† Œ… ‘…    @      
 8† ,      9†    ;† 
 :†      <†    	   .† >†     @       	3† Œ… —…    @       #      ?†  	6† Œ… ‘…    @      â   €              Eigen::CwiseNullaryOp<Eigen::internal::scalar_identity_op<double>,Eigen::Matrix<double,-1,-1,1,2,3> > .?AV?$CwiseNullaryOp@U?$scalar_identity_op@N@internal@Eigen@@V?$Matrix@N$0?0$0?0$00$01$02@3@@Eigen@@ óòñ    A†    C† >  €              Eigen::CwiseUnaryOp<Eigen::internal::scalar_abs_op<double>,Eigen::Transpose<Eigen::Block<Eigen::Matrix<double,3,2,0,3,2>,-1,-1,0> const > const > .?AV?$CwiseUnaryOp@U?$scalar_abs_op@N@internal@Eigen@@$$CBV?$Transpose@$$CBV?$Block@V?$Matrix@N$02$01$0A@$02$01@Eigen@@$0?0$0?0$0A@@Eigen@@@3@@Eigen@@ ñ   #     ñ 	¨  Œ…        @      B  €              Eigen::CwiseUnaryOp<Eigen::internal::scalar_abs2_op<double>,Eigen::Transpose<Eigen::Block<Eigen::Matrix<double,3,2,0,3,2>,-1,-1,0> const > const > .?AV?$CwiseUnaryOp@U?$scalar_abs2_op@N@internal@Eigen@@$$CBV?$Transpose@$$CBV?$Block@V?$Matrix@N$02$01$0A@$02$01@Eigen@@$0?0$0?0$0A@@Eigen@@@3@@Eigen@@ óòñ
 G† ,  >  €              Eigen::CwiseUnaryOp<Eigen::internal::scalar_arg_op<double>,Eigen::Transpose<Eigen::Block<Eigen::Matrix<double,3,2,0,3,2>,-1,-1,0> const > const > .?AV?$CwiseUnaryOp@U?$scalar_arg_op@N@internal@Eigen@@$$CBV?$Transpose@$$CBV?$Block@V?$Matrix@N$02$01$0A@$02$01@Eigen@@$0?0$0?0$0A@@Eigen@@@3@@Eigen@@ ñ    J†   B  €              Eigen::CwiseUnaryOp<Eigen::internal::scalar_sqrt_op<double>,Eigen::Transpose<Eigen::Block<Eigen::Matrix<double,3,2,0,3,2>,-1,-1,0> const > const > .?AV?$CwiseUnaryOp@U?$scalar_sqrt_op@N@internal@Eigen@@$$CBV?$Transpose@$$CBV?$Block@V?$Matrix@N$02$01$0A@$02$01@Eigen@@$0?0$0?0$0A@@Eigen@@@3@@Eigen@@ óòñ 	¨  Œ…              #      L† N  €              Eigen::CwiseUnaryOp<Eigen::internal::scalar_sign_op<double,0,0>,Eigen::Transpose<Eigen::Block<Eigen::Matrix<double,3,2,0,3,2>,-1,-1,0> const > const > .?AV?$CwiseUnaryOp@U?$scalar_sign_op@N$0A@$0A@@internal@Eigen@@$$CBV?$Transpose@$$CBV?$Block@V?$Matrix@N$02$01$0A@$02$01@Eigen@@$0?0$0?0$0A@@Eigen@@@3@@Eigen@@ óòñ 	¨  Œ…       ‹          H†    N†    Q† F  €              Eigen::CwiseUnaryOp<Eigen::internal::scalar_inverse_op<double>,Eigen::Transpose<Eigen::Block<Eigen::Matrix<double,3,2,0,3,2>,-1,-1,0> const > const > .?AV?$CwiseUnaryOp@U?$scalar_inverse_op@N@internal@Eigen@@$$CBV?$Transpose@$$CBV?$Block@V?$Matrix@N$02$01$0A@$02$01@Eigen@@$0?0$0?0$0A@@Eigen@@@3@@Eigen@@ ñ   #     ñ
 F†  òñ
 T† ,   	U† .† >†    @      &  €              Eigen::Replicate<Eigen::Transpose<Eigen::Block<Eigen::Transpose<Eigen::Matrix<double,4,4,0,4,4> > const ,1,4,1> const >,-1,-1> .?AV?$Replicate@V?$Transpose@$$CBV?$Block@$$CBV?$Transpose@V?$Matrix@N$03$03$0A@$03$03@Eigen@@@Eigen@@$00$03$00@Eigen@@@Eigen@@$0?0$0?0@Eigen@@ óòñ    V†   
 I†  òñ
 X†  òñ #      Y†  	[† Œ… ‘…   ‹       	Z† .† >†    @        €              Eigen::Reverse<Eigen::Transpose<Eigen::Block<Eigen::Transpose<Eigen::Matrix<double,4,4,0,4,4> > const ,1,4,1> const >,2> .?AV?$Reverse@V?$Transpose@$$CBV?$Block@$$CBV?$Transpose@V?$Matrix@N$03$03$0A@$03$03@Eigen@@@Eigen@@$00$03$00@Eigen@@@Eigen@@$01@Eigen@@ 
 M†  òñ      ´  ½  "  €              Eigen::Reverse<Eigen::Transpose<Eigen::Block<Eigen::Transpose<Eigen::Matrix<double,4,4,0,4,4> > const ,1,4,1> const > const ,2> .?AV?$Reverse@$$CBV?$Transpose@$$CBV?$Block@$$CBV?$Transpose@V?$Matrix@N$03$03$0A@$03$03@Eigen@@@Eigen@@$00$03$00@Eigen@@@Eigen@@$01@Eigen@@ ñ 	`† .† >†    @      
 b†  òñ
 P†  òñ      a†  	e† .† >†    @       	d† Œ… ‘…    @      
 S†  òñ 	_† Œ… —…    @       	i† .† >†    @          h†    j† 
 K†  òñ 	m† .† >†    @        €              Eigen::CwiseBinaryOp<Eigen::internal::scalar_cmp_op<double,double,0>,Eigen::Transpose<Eigen::Block<Eigen::Matrix<double,3,2,0,3,2>,-1,-1,0> const > const ,Eigen::CwiseNullaryOp<Eigen::internal::scalar_constant_op<double>,Eigen::Matrix<double,-1,-1,1,2,3> > const > .?AV?$CwiseBinaryOp@U?$scalar_cmp_op@NN$0A@@internal@Eigen@@$$CBV?$Transpose@$$CBV?$Block@V?$Matrix@N$02$01$0A@$02$01@Eigen@@$0?0$0?0$0A@@Eigen@@@3@$$CBV?$CwiseNullaryOp@U?$scalar_constant_op@N@internal@Eigen@@V?$Matrix@N$0?0$0?0$00$01$02@3@@3@@Eigen@@ N  €              Eigen::internal::pointer_based_stl_iterator<Eigen::Transpose<Eigen::Block<Eigen::Transpose<Eigen::Matrix<double,4,4,0,4,4> > const ,1,4,1> const > > .?AV?$pointer_based_stl_iterator@V?$Transpose@$$CBV?$Block@$$CBV?$Transpose@V?$Matrix@N$03$03$0A@$03$03@Eigen@@@Eigen@@$00$03$00@Eigen@@@Eigen@@@internal@Eigen@@ óòñ
 o†  òñ
 ÖY ,   	q† .† >†   @      V  €              Eigen::internal::pointer_based_stl_iterator<Eigen::Transpose<Eigen::Block<Eigen::Transpose<Eigen::Matrix<double,4,4,0,4,4> > const ,1,4,1> const > const > .?AV?$pointer_based_stl_iterator@$$CBV?$Transpose@$$CBV?$Block@$$CBV?$Transpose@V?$Matrix@N$03$03$0A@$03$03@Eigen@@@Eigen@@$00$03$00@Eigen@@@Eigen@@@internal@Eigen@@ ñ
    r†   €              Eigen::CwiseBinaryOp<Eigen::internal::scalar_min_op<double,double,0>,Eigen::Transpose<Eigen::Block<Eigen::Matrix<double,3,2,0,3,2>,-1,-1,0> const > const ,Eigen::CwiseNullaryOp<Eigen::internal::scalar_constant_op<double>,Eigen::Matrix<double,-1,-1,1,2,3> > const > .?AV?$CwiseBinaryOp@U?$scalar_min_op@NN$0A@@internal@Eigen@@$$CBV?$Transpose@$$CBV?$Block@V?$Matrix@N$02$01$0A@$02$01@Eigen@@$0?0$0?0$0A@@Eigen@@@3@$$CBV?$CwiseNullaryOp@U?$scalar_constant_op@N@internal@Eigen@@V?$Matrix@N$0?0$0?0$00$01$02@3@@3@@Eigen@@  	t† Œ… ‘…    @      
 v†  òñ 	p† Œ… —…    @       	x† .† >†   @          w†    y†  «Y    u†   €              Eigen::CwiseBinaryOp<Eigen::internal::scalar_max_op<double,double,0>,Eigen::Transpose<Eigen::Block<Eigen::Matrix<double,3,2,0,3,2>,-1,-1,0> const > const ,Eigen::CwiseNullaryOp<Eigen::internal::scalar_constant_op<double>,Eigen::Matrix<double,-1,-1,1,2,3> > const > .?AV?$CwiseBinaryOp@U?$scalar_max_op@NN$0A@@internal@Eigen@@$$CBV?$Transpose@$$CBV?$Block@V?$Matrix@N$02$01$0A@$02$01@Eigen@@$0?0$0?0$0A@@Eigen@@@3@$$CBV?$CwiseNullaryOp@U?$scalar_constant_op@N@internal@Eigen@@V?$Matrix@N$0?0$0?0$00$01$02@3@@3@@Eigen@@ n  €              Eigen::CwiseUnaryOp<Eigen::internal::scalar_imag_op<